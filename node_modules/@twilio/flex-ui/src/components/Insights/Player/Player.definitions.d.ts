...
export declare type PlayerComponentProps = {
    ...
    env?: object;
    onOpenInConversationScreen?: () => void;
};
...
export declare type InsightsPlayerMediaLink = InsightsMediaLinkWithUrl | InsightsMediaLinkWithSid | InsightsVoiceRecordingMediaLink | InsightsEmailTranscriptMediaLink;
/**
