import { WorkerQueue, WorkspaceStats, QueuesState, QueuesFilterFunction, WorkerQueueMetadata, WorkerQueueTasksNow, WorkerQueueWorkerStatistics, WorkerQueueSLA } from "./QueuesStateTypes";
...
export declare const metadata: WorkerQueueMetadata;
