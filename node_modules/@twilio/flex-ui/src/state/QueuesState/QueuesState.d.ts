...
import { QueuesConfig, QueuesStateActionTypes, QueuesState, QueuesFilterFunction, WorkerQueueChannelMetadata, TRQueue } from "./QueuesStateTypes";
...
export declare class Actions {
    ...
    static fetchQueueSids(): Promise<string[]>;
