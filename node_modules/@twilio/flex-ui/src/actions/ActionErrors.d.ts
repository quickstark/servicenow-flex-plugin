export declare enum ActionErrors {
    ...
    VOICE_CONNECTION_ALREADY_LIVE = "voice connection already live",
    ...
    ERROR_HOLDING_CALL = "error holding call",
    ERROR_UNHOLDING_CALL = "error unholding call",
    ...
    CANT_MUTE_WITH_NO_LIVE_CONNECTIONS = "cannot call mute with no live connection",
