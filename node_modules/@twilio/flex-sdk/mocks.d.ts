 ...
 * @public
 */
declare interface AccountConfigData<TUI = any> {
    /**
 ...
 * @public
 */
declare type AccountConfigKeys = keyof AccountConfigData;

/**
 * Account sid option
 * @public
 */
declare interface AccountSidOption {
    /**
     * Account sid
     */
    accountSid: string;
 ...
 * @public
 */
declare interface ActivityStats {
    /**
     * Activity SID
     */
    sid: string;
 ...
 * @public
 */
declare type AuthenticatorFactory = (accountSid: string) => Authenticator;
...
export declare class AuthenticatorMock implements Authenticator {
    ...
    refreshToken: jest.Mock<Promise<string>, [string]>;
    getIdpUrl: jest.Mock<Promise<string>, [IdpConfig]>;
 ...
 * @public
 */
declare interface ClientConfigType {
 ...
 * @public
 */
declare type ClientProvider = (token: string, userSettings?: ClientUserSettings) => Promise<Client>;
 ...
 * @public
 */
declare type ClientUserSettings = DeepPartial<ClientSettings>;
 ...
 * @public
 */
declare interface CurrentTasksStats {
    /**
 ...
 * @public
 */
declare interface DefaultQueueStatsConfiguration {
 ...
 * @public
 */
export declare const getMock: <T extends "auth" | "getLogger" | "getTwilioIdpUrl" | "getPublicConfig" | "makeCreateClient">(name: T, config?: Parameters<Mocks[T]>[0] | undefined) => ReturnType<Mocks[T]>;
 ...
 * @public
 */
declare interface HistoricalTasksStats {
    /**
     * Total tasks count
     */
 ...
 * @public
 */
declare interface IntegrationsConfig {
    name: string;
    type: string;
    active: boolean;
    config: object;
 ...
 * @public
 */
declare type LoggerFactory<TName = LoggerName> = (name: TName) => Logger;

/**
 * Logger level
 * @public
 */
declare type LoggerLevel = LogLevelDesc;

/**
 * @public
 */
declare type LoggerLevelNumbers = LogLevelNumbers;

/**
 * @public
 */
declare enum LoggerName {
    Client = "flex:Client",
 ...
 * @public
 */
declare interface LoggerSettings {
    level: LoggerLevel;
}
 ...
 * @public
 */
declare interface OutboundFlows {
    /**
     * Enable flag
     */
    enabled: boolean;
 ...
 * @public
 */
declare interface PublicConfigAttributes {
 ...
 * @public
 */
declare type PublicConfigProvider = (option: XOR<AccountSidOption, RuntimeDomainOption>) => Promise<PublicConfig>;
 ...
 * @public
 */
declare interface QueueChannelConfiguration {
    /**
     * Queue sid
     */
    queue_sid: string;
 ...
 * @public
 */
declare interface QueueConfiguration {
    queue_sid: string;
    reset_timezone: string;
    reset_time: string;
}
 ...
 * @public
 */
declare interface QueueStatsConfiguration {
 ...
 * @public
 */
declare interface RealtimeStats {
    getQueueStatsBySid(queueSid: string): Promise<QueueStats>;
}
 ...
 * @public
 */
declare type Role = "guest" | "agent" | "admin" | "supervisor";

/**
 * Runtime domain option
 * @public
 */
declare interface RuntimeDomainOption {
    /**
     * Runtime domain
     */
    runtimeDomain: string;
 ...
 * @public
 */
declare interface SessionSettings {
 ...
 * @public
 */
declare interface TaskChannelStats {
    sid: string;
    friendlyName: string;
    tasks: TasksByTime;
}
 ...
 * @public
 */
declare interface TelemetryClient<U extends object = object> {
    /**
 ...
 * @public
 */
declare interface TelemetryErrorEvent extends TelemetryEvent {
    /**
     * Error code
     */
    errorCode: number;
 ...
 * @public
 */
declare interface TelemetryEventGroup<T> {
    /**
     * Group name
     */
    name?: string;
     ...
     */
    addEvents(...events: (T & TelemetryEvent)[]): Promise<void>;
    /**
     * Add error event to group
     * @param event - ErrorEvent to be added
     */
    addErrorEvent(events: TelemetryErrorEvent): Promise<void>;
}
 ...
 * @public
 */
declare type TwilioIdpUrlFunction = (port?: string) => string;
 ...
 * @public
 */
declare interface WorkerChannel {
    /**
