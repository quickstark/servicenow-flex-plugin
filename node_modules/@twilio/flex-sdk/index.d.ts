 ...
 * @public
 */
export declare type ClientProvider = (token: string, userSettings?: ClientUserSettings) => Promise<Client>;
 ...
 * @public
 */
export declare type ClientUserSettings = DeepPartial<ClientSettings>;
...
export declare enum ErrorCode {
    ...
    /**
     * Sync map item data invalid
     */
    SyncInvalidMapItemDataError = 54206,
    /**
     * Sync map item key invalid
     */
 ...
 * @public
 */
export declare abstract class EventPublisher<E extends string | symbol> {
    private readonly emitter;
    on(eventName: E, listener: (...args: unknown[]) => void): this;
    removeAllListeners(): this;
    removeListener(eventName: E, listener: (...args: unknown[]) => void): this;
    protected emit(event: E, ...args: unknown[]): boolean;
    protected proxyEvent<T extends string | symbol>(from: EventPublisher<T> | EventEmitter, event: T, alias: E): void;
}
...
export declare class FlexSdkError extends Error {
    ...
    /**
     * Gets the source Error that caused the exception
 ...
 * @public
 */
export declare interface LoggerSettings {
    level: LoggerLevel;
}
 ...
 * @public
 */
export declare interface SessionSettings {
 ...
 * @public
 */
export declare type Subscribable<T> = T & {
