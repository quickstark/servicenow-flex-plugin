...
<head>
    <title>Code coverage report for src/ui/Markings.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/ui</a> Markings.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
interface MarkingsContext {
  pxPerSec: number
  containerWidth: number
  regionsContainer?: HTMLElement | null
}
&nbsp;
export const MarkingsContext = React.createContext&lt;MarkingsContext&gt;({
  pxPerSec: 0,
  containerWidth: 0,
...
&nbsp;
    return (
      &lt;MarkingsContext.Consumer&gt;
        {({ pxPerSec, containerWidth, regionsContainer }) =&gt; offset * pxPerSec &lt;= containerWidth ? (
          &lt;&gt;
            {children &amp;&amp; (
              &lt;div
                style={{
    ...
    return {
      ...
      width:
        Math.min(
          ...
          containerWidth - this.props.offset * pxPerSec
        ) + "px",
      height: "100%",
    }
  }
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Sep 22 2020 13:54:24 GMT+0200 (Central European Summer Time)
            </div>
        </div>
