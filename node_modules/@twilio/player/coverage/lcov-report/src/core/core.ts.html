    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>150/151</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>149/150</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import WaveSurfer, { PluginDefinition } from "wavesurfer.js"
...
&nbsp;
export class PlayerCore extends EE&lt;PlayerEvents&gt; {
...
&nbsp;
  public load = (url: string, channels: Channel[] = []) =&gt; {
    this.destroy()
    ...
    ws.load(this.mediaElement, peaks)
  }
&nbsp;
  public hotLoad = async (url: string) =&gt; {
    if (!this.ws) {
      throw new Error(
...
&nbsp;
  public seekToSecond = (seconds: number) =&gt; {
